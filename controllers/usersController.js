...
exports.find = function (APP, req, callback) {
	...
	if (req.body.nip) query.where.nip = req.body.nip;
    ...
    if ( req.body.str_last_login && req.body.end_last_login ){
		query.where.last_login = {
	        [Op.between]: [req.body.str_last_login, req.body.end_last_login]
	    }
	}
...
exports.count = function (APP, req, callback) {
	APP.models.mysql.rs.users.count().then((rows) => {
		return callback(null, {
...
exports.update = function (APP, req, callback) {	
	...
	if (req.body.dataUpdate.nip) params.dataUpdate.nip = req.body.dataUpdate.nip;
...
exports.delete = function (APP, req, callback) {
	...
	APP.models.mysql.rs.users.destroy(params).then(deleted => {
